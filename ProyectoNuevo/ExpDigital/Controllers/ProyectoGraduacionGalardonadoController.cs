...
namespace ExpDigital.Controllers
{
    public class ProyectoGraduacionGalardonadoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,nombre")] ProyectoGraduacionGalardonado proyectoGraduacionGalardonado)
        {
            if (ModelState.IsValid)
            {
                db.ProyectoGraduacionGalardonadoes.Add(proyectoGraduacionGalardonado);
                db.SaveChanges();
